...
export const getRolesThunk = createAsyncThunk('setting/getRoles',
  async(_ , {rejectWithValue})=>{
    try{
...
export const addStaffThunk = createAsyncThunk('setting/addStaff',
  async(formData , {rejectWithValue})=>{
    try{
...
export const getResturantStatusThunk = createAsyncThunk('setting/getResturantStatus',
  async(_ , {rejectWithValue})=>{
    try{
      const response = await getResturantStatus()
      return response.data
    }catch(error){
      return rejectWithValue(error.response?.data || error.message);  
    }
...
export const openStatusThunk = createAsyncThunk('setting/openStatus',
  async(formData = { status: 'open' } , {rejectWithValue})=>{
    try{
      const response = await openStatus(formData)
...
export const busyStatusThunk = createAsyncThunk('setting/busyStatus',
  async(formData = { status: 'busy' } , {rejectWithValue})=>{
    try{
      const response = await busyStatus(formData)
      return response.data || response
    }catch(error){
      return rejectWithValue(error.response?.data || error.message);  
    }
...
export const closedStatusThunk = createAsyncThunk('setting/closedStatus',
  async(formData = { status: 'closed' } , {rejectWithValue})=>{
    try{
      const response = await closedStatus(formData)
      return response.data || response
    }catch(error){
      return rejectWithValue(error.response?.data || error.message);  
    }
...
export const getRatingConfigThunk = createAsyncThunk('setting/getRatingConfig',
  async(_ , {rejectWithValue})=>{
    try{
...
export const addReplyThunk = createAsyncThunk('setting/addReply',
  async({id , formData} , {rejectWithValue})=>{
    try{
      const response = await addReply(id , formData)
      return response 
    }catch(error){
      return rejectWithValue(error.response?.data || error.message);  
    }
...
export const getWorkingHoursConfigThunk = createAsyncThunk('setting/getWorkingHoursConfig',
  async(_ , {rejectWithValue})=>{
    try{
      const response = await getWorkingHoursConfig()
      return response.data
    }catch(error){
      return rejectWithValue(error.response?.data || error.message);  
    }
...
export const EditWorkingHoursConfigThunk = createAsyncThunk('setting/EditWorkingHoursConfig',
  async(formData , {rejectWithValue})=>{
    try{
      const response = await EditWorkingHoursConfig(formData)
      return response
    }catch(error){
      return rejectWithValue(error.response?.data || error.message);  
    }
...
//---------------------------------------------------------------------------------------
/**delivery */
export const getShowSettingThunk = createAsyncThunk('setting/getShowSetting',
  async(_ , {rejectWithValue})=>{
    try{
      const response = await getShowSetting()
...
export const ParcelSettingThunk = createAsyncThunk('setting/ParcelSetting',
  async(formData , {rejectWithValue} )=>{
    try{
      const response = await ParcelSetting(formData)
      return response
    }catch(error){
      return rejectWithValue(error.response?.data || error.message);  
    }
...
/***************************************************************** */
      ...
      //getResturantStatusThunk
      .addCase(getResturantStatusThunk.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(getResturantStatusThunk.fulfilled, (state ,action ) => {
        state.loading = false;
        state.getResturantStatus = action.payload;
      })
      .addCase(getResturantStatusThunk.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload;
      })
      //openStatusThunk
      .addCase(openStatusThunk.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(openStatusThunk.fulfilled, (state ,action ) => {
        state.loading = false;
      })
      .addCase(openStatusThunk.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload;
      })
      //busyStatusThunk
      .addCase(busyStatusThunk.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(busyStatusThunk.fulfilled, (state ,action ) => {
        state.loading = false;
      })
      .addCase(busyStatusThunk.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload;
      })
      //closedStatusThunk
      .addCase(closedStatusThunk.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(closedStatusThunk.fulfilled, (state ,action ) => {
        state.loading = false;
      })
      .addCase(closedStatusThunk.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload;
      })
      //getRatingConfigThunk
      .addCase(getRatingConfigThunk.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(getRatingConfigThunk.fulfilled, (state ,action ) => {
        state.loading = false;
        state.getRatingConfig = action.payload;
      })
      .addCase(getRatingConfigThunk.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload;
      })
      //addReplyThunk
      ...
      //getWorkingHoursConfigThunk
      .addCase(getWorkingHoursConfigThunk.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(getWorkingHoursConfigThunk.fulfilled, (state ,action ) => {
        state.loading = false;
        state.getWorkingHoursConfig = action.payload;
      })
      .addCase(getWorkingHoursConfigThunk.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload;
      })
      //EditWorkingHoursConfigThunk
      .addCase(EditWorkingHoursConfigThunk.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(EditWorkingHoursConfigThunk.fulfilled, (state ,action ) => {
        state.loading = false;
      })
      ...
      //getShowSettingThunk
      .addCase(getShowSettingThunk.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(getShowSettingThunk.fulfilled, (state ,action ) => {
        state.loading = false;
        state.getShowSetting = action.payload;
      })
      .addCase(getShowSettingThunk.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload;
      })
      //ParcelSettingThunk
      .addCase(ParcelSettingThunk.pending, (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase(ParcelSettingThunk.fulfilled, (state ,action ) => {
        state.loading = false;
      })
      .addCase(ParcelSettingThunk.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload;
      })
