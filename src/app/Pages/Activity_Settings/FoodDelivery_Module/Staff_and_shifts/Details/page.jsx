  ...
  return (
    ...
    >
      ...
      <div className='p-6 flex flex-col gap-1 items-center'>
        ...
        <p className='text-[#364152] text-xl font-normal'>أحمد محمد سالم</p>
      ...
      <div className='p-6 flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-4 mt-4 '>
            ...
            <div className='border border-[#CDD5DF] rounded-[3px] p-3 flex gap-3 '>
              ...
              <div className='flex flex-col gap-1'>
                ...
                <p className='text-[#697586] text-sm font-normal'>0501234567</p>
              </div>
            </div>
            ...
            <div className='border border-[#CDD5DF] rounded-[3px] p-3 flex gap-3 '>
              ...
              <div className='flex flex-col gap-1'>
                ...
                <p className='text-[#697586] text-sm font-normal'>Exmple@gmail.com</p>
              </div>
            </div>
        ...
        <div className='shadow-[0_0_4px_0_rgba(0,0,0,0.20)] rounded-[3px] p-4'>
          ...
          <div className='flex flex-col gap-3 '>
            <div className='flex gap-2 p-3 border border-[#CDD5DF] rounded-[3px] mt-3'>
              <p className='flex items-center'>
                <img src="/images/icons/checkmark-circle-yellow.svg" className="w-5 h-5" />
              </p>
              <p className='text-[#364152] text-sm font-normal'>إدارة الطلبات</p>
            </div>
        ...
        <div className='flex gap-2 w-full'>
          ...
          <button
            ...
            className='w-full bg-[var(--color-primary)] text-white text-base font-semibold py-3 px-6 rounded-[3px]  cursor-pointer'
          >
            {t('Role modification')}
          </button>
        </div>
