    ...
    <>
      <div className=' w-full   border border-[#CDD5DF] rounded-[3px] p-4'>
          ...
          <div className="flex justify-between items-center  ">
            ...
            <p className="text-[#364152] text-sm font-medium w-[30%]">مصر</p>
          </div>
          <div className="flex justify-between items-center py-3 ">
            <p className="text-[#4B5565] text-sm font-normal">{t('City')}</p>
            <p className="text-[#364152] text-sm font-medium w-[30%]">القاهرة</p>
          </div>
          <div className="flex justify-between items-center  ">
            <p className="text-[#4B5565] text-sm font-normal">{t('region')}</p>
            <p className="text-[#364152] text-sm font-medium w-[30%]">مصر الجديدة</p>
          </div>
