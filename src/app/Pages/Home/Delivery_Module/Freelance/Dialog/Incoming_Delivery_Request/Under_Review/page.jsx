    ...
    >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="px-6 flex flex-col gap-1">
          <p className="text-[#364152] text-2xl font-medium tracking-tight">{t('The offer has been sent')}</p>
          <p className="text-[#666B6D] text-base font-normal">{t('Awaiting customer response')}</p>
        </motion.div>
