...
// function createData(orderNumber, customerName, service, dateTime, worker, status, price) {
//   return { orderNumber, customerName, service, dateTime, worker, status, price };
// }


// const rows = [
//   createData('#001', 'Aly salem', 'AC Repair', '2025-10-12 / 10:30 AM', 'Omar Khaled', 'Completed', '$50'),
//   createData('#002', 'Mona Yasser', 'Plumbing', '2025-10-13 / 02:15 PM', 'Sara Adel', 'Pending', '$30'),
//   createData('#003', 'Khaled Mahmoud', 'Electric Fix', '2025-10-13 / 05:00 PM', 'Ali Hassan', 'In Progress', '$40'),
//   createData('#004', 'Fatma Hassan', 'Cleaning', '2025-10-14 / 09:00 AM', 'Noor Samir', 'Canceled', '$20'),
// ];
...
//         <TableHead>
//           <TableRow PaperProps={{ className:'TableHead'}}>
//             <TableCell align="right">{t('order number')}</TableCell>
//             <TableCell align="right">{t('Customer name')}</TableCell>
//             <TableCell align="right">{t('Service')}</TableCell>
//             <TableCell align="right">{t('the date')}/{t('the time')}</TableCell>
//             <TableCell align="right">{t('The worker')}</TableCell>
//             <TableCell align="right">{t('Status')}</TableCell>
//             <TableCell align="right">{t('the price')}</TableCell>
